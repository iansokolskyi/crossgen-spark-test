...
**Triggers contain instructions inline, NOT references to separate SOP files.**

The PRD used the term "SOP" which was confusing. Here's the corrected understanding:
